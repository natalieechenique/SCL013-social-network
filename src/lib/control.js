        ...
        signUp(email2, password2)
            .then(() => {
                ...
                return promiseOfSetFirebase('users', user.uid, {
                        name: userName,
                        photo: 'https://icons-for-free.com/iconfiles/png/512/r2d2+robot+starwars+icon-1320166698566079188.png',
                        userId: user.uid,
                        email: email2,
                    })
                    .then(() => {
...
const manejarInfoEnviada = (inputComment, idUser, statusComment, /* progress, */ selectedFile) => {
