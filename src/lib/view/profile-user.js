...
const renderOnePost = (post, user, current) => {
  ...
  <img src='likestar.png' width='25' height='25' class='icons like'id='btn-likes' alt='icon like'>
  <span id='counter-likes' >${post.likes}</span> &nbsp
  ...
  divElement.innerHTML = `
   ...
   <div class='user-name'>
            <div class='element'><img class='image-photo' id='image-user' src='${photoUrl}' width='50' height='50' alt='default photo'> </div>
                <div class='nombre'><h3 id='name-user'>${user.name} &nbsp <i class='fab fa-jedi-order'></></h3></i>${user.email}</p>
                </div>
