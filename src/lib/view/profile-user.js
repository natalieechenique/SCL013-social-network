...
const renderOnePost = (post, user, current) => {
  ...
  <span id='counter-likes'>${post.likes.length}</span> &nbsp
  ...
  divElement.innerHTML = `
   ...
   <div class='user-name'>
            <div class='element'><img class='image-photo' id='image-user' src='${photoUrl}' alt='default photo'></div>
                <div class='nombre'><h3 id='name-user'>${user.name} &nbsp <i class='fab fa-jedi-order'></i></h3></i>${user.email}</p>
                </div>
                <!-- menu usuario -->
                <div class='menu2'>
